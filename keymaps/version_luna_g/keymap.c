...
const uint16_t PROGMEM temp_active_boot[] = {MY_NAV,HT_SPC,KC_LGUI,KC_LALT,CSTM_ENT,MY_LCTL, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT,    FR_A,    KC_R,    KC_S,    KC_T,    KC_D,                         KC_H,    KC_N,    HT_E,    KC_I,    KC_O, MY_LSFT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL,    FR_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_K,    FR_M, FR_COMM,  FR_DOT, FR_QUES, MY_LCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          MY_NAV,  HT_SPC, KC_LGUI,     KC_LALT,CSTM_ENT, MY_LCTL
                                      //`--------------------------'  `--------------------------'
  ),
  //   // _GAMING for gaming
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       MY_ESC,    FR_Q,    FR_W,    KC_F,    KC_P,    KC_G,                         KC_J,    KC_L,    KC_U,    KC_Y, XXXXXXX,  KC_TAB,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT,    FR_A,    KC_R,    KC_S,    KC_T,    KC_D,                         KC_H,    KC_N,    KC_E,    KC_I,    KC_O, MY_LSFT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL,     FR_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_K,    FR_M, FR_COMM,  FR_DOT, FR_QUES,MY_LCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           MY_NAV,  HT_SPC, KC_LGUI,    KC_LALT,CSTM_ENT, MY_LCTL
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT, S(FR_A), S(KC_R), S(KC_S), S(KC_T), S(KC_D),                      S(KC_H), S(KC_N), S(KC_E), S(KC_I), S(KC_O), MY_LSFT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL, S(FR_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B),                      S(KC_K), S(FR_M), FR_COMM,  FR_DOT, FR_QUES, MY_LCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           MY_NAV,  HT_SPC, KC_LGUI,    KC_LALT,CSTM_ENT, MY_LCTL 
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, MY_LCTL 
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT, XXXXXXX,   KC_F4,   KC_F5,   KC_F6,  KC_F11,                      KC_BSPC, KC_LEFT, KC_DOWN,KC_RIGHT,  KC_DEL, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL, XXXXXXX,   KC_F1,   KC_F2,   KC_F3,  KC_F10,                      XXXXXXX, KC_HOME, XXXXXXX,  KC_END, XXXXXXX, MY_LCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           MY_NAV, XXXXXXX, XXXXXXX,    KC_LALT, KC_LCTL, MY_LCTL
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+-----------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT,      KC_P0,   KC_P4,   KC_P5,   KC_P6, KC_PDOT,                      KC_BSPC, KC_LEFT, KC_DOWN,KC_RIGHT,  KC_DEL, XXXXXXX,
  //|--------+-  --------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL,    XXXXXXX,   KC_P1,   KC_P2,   KC_P3,  KC_ENT,                      XXXXXXX, KC_HOME, XXXXXXX,  KC_END, XXXXXXX, MY_LCTL,
  //|--------+-----------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                             _______, _______, _______,    KC_LALT, KC_LCTL,  MY_LCTL
                                      //`-----------------------------'  `--------------------------'
  ),
  ...
  //|--------+-----------+--------+----------+----------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,    XXXXXXX, KC_PMNS,    KC_EQL,   KC_PPLS, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------+-  --------+--------+----------+----------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL,    XXXXXXX, KC_PSLS,   XXXXXXX,   KC_PAST, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------+-----------+--------+----------+----------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                             XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,  XXXXXXX, XXXXXXX
                                      //`-----------------------------'  `--------------------------'
  ),
  ...
  //|--------+---------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LSFT,     HT_A, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_BSPC, XXXXXXX,     HT_E,    HT_I,MY_OCIRC, MY_LSFT,
  //|--------+---------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_LCTL,  XXXXXXX, XXXXXXX, C_CEDIL, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, FR_COLN, FR_SCLN, FR_EXLM, MY_LCTL,
  //|--------+---------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           MY_NAV,   HT_SPC, KC_LGUI,    KC_LALT,CSTM_ENT, XXXXXXX 
                                       //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+----------+--------+----------+--------|
      MY_LSFT,   FR_AT, KC_PMNS,  KC_EQL, KC_PPLS, MY_DOLL,                      FR_ASTR, XXXXXXX,   FR_QUOT, FR_DQUO,   XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+----------+--------+----------+--------|
      MY_LCTL, XXXXXXX, KC_PSLS, MY_PIPE, KC_PAST, MY_EURO,                      FR_AMPR, FR_LPRN,ALGR(KC_8), FR_RPRN,   XXXXXXX, MY_LCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+----------+--------+----------+--------|
...
void render_layer_status(void) {
  switch (get_highest_layer(layer_state)){
    case _COLEMAK_FR :
      ...
      //         "                                             "
      oled_write("COLE-  MAK       FR                      LUNA", false);
      break;
    // case _GAMING :
    //   // -------|"-----00000-----00000-----00000-----00000-----"
    //   //         "                                             "
    ...
    case _SFT_COLEMAK_FR :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write(" MAJ                                     LUNA", false);
      break;
    case _CAPS_LOCK :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write(" VERR MAJ                                LUNA", false);
      break;
    case _OSL_SHIFT :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write(" Uni- que  MAJ                           LUNA", false);
      break;
    case _F_KEYS :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("  F_  KEYS                               LUNA", false);
      break;
    // case _WEB_BROWSER :
    //   // -------|"-----00000-----00000-----00000-----00000-----"
    //   //         "                                             "
    ...
    case _NAV :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("  NAV                                    LUNA", false);
      break;
    case _OP_NAV :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("OPERA TEUR                               LUNA", false);
      break;
    case _ACCENTS :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("ACCE-  NTS                               LUNA", false);
      break;
    case _REG_SPE :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("CARACTERES     SPEC- IAUX                LUNA", false);
      break;
    case _MULTIMEDIA :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write("MULTIMEDIA                               LUNA", false);
      break;
    case _RGB :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write(" RGB                                     LUNA", false);
      break;
    case _RIEN :
      // -------|"-----00000-----00000-----00000-----00000-----"
      //         "                                             "
      oled_write(" RIEN                                    LUNA", false);
      break;
  }
}
